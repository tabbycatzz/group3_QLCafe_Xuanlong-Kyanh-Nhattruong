...
<html>
  ...
  <script language=javascript>
	function s()
	{
		document.getElementById("1") .style.background="rgb(245, 65, 65)";
	...
	function m()
		...
		document.getElementById("2") .style.background="rgb(245, 65, 65)";
        document.getElementById("3") .style.color="black";
		document.getElementById("3") .style.background="white";
    ...
    function l()
		...
		document.getElementById("3") .style.background="rgb(245, 65, 65)";
	...
	<div class='mn'>
		...
		<div id='topright'>
			...
			<div id='title'><a href="home.php"><img src="./hinhanh/logoo.png" /></a></div>
            <div class="timkiem">
				...
				<div class="btn-group">
					<button type="button" class="btn btn-warningg dropdown-toggle" data-toggle="dropdown">
					  ...
					  <ul class="dropdown-menu" role="menu">
						<li><a href="listcf.php">Cà Phê Phin</a></li>
							...
							<div class="btn-group">
								<button type="button" class="btn btn-warningg dropdown-toggle" data-toggle="dropdown">
								  ...
								  <ul class="dropdown-menu">
									<li><a href="listtea.php">Trà Thạch</a></li>
...
<div class="king">
	...
	<div class='long'>
	<h1>Phin Đen Đá</h1>
    <div class="image">	<img href='#' src="./list/cf1.png"/>   </div>

	
			<!-- <div class="continued"> <input type="submit" value="Xem sản phẩm"/> </div> -->
		</div>
<div class='minhhoa'>
	<p>Dành cho những tín đồ cafe đích thực! Hương vị cafe truyền thống được phối trộn độc đáo tại Time Coffee.
        Cafe đậm đà được pha hoàn toàn từ phin, cho thêm một thìa đường, một ít đá viên mát lạnh , tạo nên phin đen 
        đá mang vị cafe đậm chất phin.
    </p>
        
        <div class='color1'>
            <span id='long'> Chọn size:</span>
            </div>
            <div class="middle">
                <span><input onclick="s()" id=1 type="submit" value="S"></input></span>
                <span><input onclick="m()" id=2 type="submit" value="M"></input></span>	
                <span><input onclick="l()" id=3 type="submit" value="L"></input></span>	
            </div>
            <div class='color1'>
                <span id='long'> Số lượng</span>
                </div>
                <div class="number">
                    <div class="input-group" >
                    
                      <div class="tru"><input class="js-btn-minus" value="-" type="submit"></input></div>
                   
                    <div class="mot"><input type="text" class="form-control text-center" value="1" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1"></div>
                   
                    <div class="cong"> <input type="submit" class="js-btn-plus" value="+"></input> </div>
            ...
            <div class='details2'>
                ...
                <a >Giá: <b> 29.000 VNĐ</b>
                </a>
                </div>

       <div class="buy"> <input  type="submit" value="Mua Ngay"> </div>
</div>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item active">
              <li>
                  <table class="sanpham1">
              
                          <tr><td>
                          
                              <div class='imgbox'>
                                  <img href='#' src="./list/cf1.png" width="180px" height="180px"/>
                              </div>
                      ...
                      <li>
                          <table class="sanpham1">
                                  ...
                                  <tr><td>
                                      ...
                                      <div class='imgbox'>
                                          <img href='#' src="./list/cf3.png"  width="180px" height="180px"/>
                                      </div>
                              ...
                              <li>
                                  <table class="sanpham1">
                                          ...
                                          <tr><td>
                                              ...
                                              <div class='imgbox'>
                                                  <img href='#' src="./list/cf2.png"  width="180px" height="180px"/>
                                              </div>
                                      ...
                                      <tr><td>
                                          <div class='details1'>
                                              <h2>Phin Sữa Nóng</h2><br>
                                                  <a >Giá: <b> 39.000 VNĐ</b>
                                              </a>
                                              </div></td>
                                          </td></tr>
                                      </table>
              ...
              <li>
                  <table class="sanpham1">
                          ...
                          <tr><td>
                              ...
                              <div class='imgbox'>
                                  <img href='#' src="./list/cf7.png" width="180px" height="180px"/>
                              </div>
                      ...
                      <li>
                          <table class="sanpham1">
                                  ...
                                  <tr><td>
                                      ...
                                      <div class='imgbox'>
                                          <img href='#' src="./list/cf8.png"  width="180px" height="180px"/>
                                      </div>
...
<div class="khac">
	...
	<ul>
		<li>
            <table class="khac1">
                ...
                <div class='product'>
                    <div class='imgbox'>
                        <img href='#' src="./list/cafe2.png" width="280px" height="270px"/>
                    </div>
            ...
            <tr><td>
                <div class='details'>
                    <h2>Trà</h2><br>
                    <a >Hương vị tự nhiên, thơm ngon của trà Việt với phong cách<br> hiện 
                         đại tại Coffee Time sẽ giúp bạn gợi mở vị giác của bản thân và tận hưởng...
                    </a>
                    </div></td>
                </td></tr>
            </table>
		...
		<li>
			<table class="khac1">
					...
					<div class='product'>
						<div class='imgbox'>
							<img href='#' src="./list/cafe1.png" width="280px" height="270px"/>
						</div>
				...
				<tr><td>
					<div class='details'>
						<h2>Freeze</h2><br>
						<a >Sảng khoái với thức uống đá xay phong cách Việt. <br> freeze là thức uống đá xay mát lạnh được pha chế <br> từ những 
							nguyên liệu thuần túy của Việt Nam.
						</a>
						</div></td>
					</td></tr>
				</table>
	...
	<table class="khac1">
			...
			<div class='product'>
				<div class='imgbox'>
					<img href='#' src="./list/khac.jpg" width="280px" height="270px"/>
				</div>
		...
		<tr><td>
			<div class='details'>
				<h2>Khác</h2><br>
				<a >Sẽ còn ngon miệng hơn khi bạn kết hợp đồ uống với <br> những chiếc bánh ngọt thơm ngon được làm thủ công hàng ngày ngay tại bếp 
				bánh của Time</p>
				</a>
				</div></td>
			</td></tr>
