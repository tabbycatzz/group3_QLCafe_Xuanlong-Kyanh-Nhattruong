			...
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form action="" method="post" class="login100-form validate-form p-b-33 p-t-5">
					...
					<div class="container-login100-form-btn m-t-32">
						<input type="submit" name="btn" class="login100-form-btn" data-toggle="modal" data-target="#myModal" value="Đăng nhập">
					</div>
				</form>
			</div>
		</div>
		...
		<?php
			...
			if(isset($_POST['btn'])){
				...
				if($pass==$row['password']){
					if($row['level'] == 1){
						echo 'Đăng nhập quản trị thành công'; ?> <a href="http://localhost/final/Do-an/sql.php" class="alert-link">chuyển đến trang admin</a>. <?php
					}
					else{
