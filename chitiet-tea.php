...
<div class="king">
	...
	<div class='long'>
	<h1>Trà Chanh Đào</h1>
    <div class="image">	<img href='#' src="./list/tea2.png"/>   </div>

	
			<!-- <div class="continued"> <input type="submit" value="Xem sản phẩm"/> </div> -->
		</div>
<div class='minhhoa'>
	<p>Một trải nghiệm thú vị khác! Sự hài hòa giữa vị trà cao cấp, 
        vị sả thanh mát và những miếng đào thơm ngon mọng nước sẽ mang đến cho bạn một thức uống tuyệt vời.</p>
            ...
            <li>
                <table class="sanpham1">
                        ...
                        <tr><td>
                            ...
                            <div class='imgbox'>
                                <img href='#' src="./list/tea.png" width="180px" height="180px"/>
                            </div>
                    ...
                    <li>
                        <table class="sanpham1">
                                ...
                                <tr><td>
                                    ...
                                    <div class='imgbox'>
                                        <img href='#' src="./list/tea3.png"  width="180px" height="180px"/>
                                    </div>
                            ...
                            <tr><td>
                                <div class='details1'>
                                    <h2>Trà Thạch Đào</h2><br>
                            <a >Giá: <b> 39.000 VNĐ</b> </a>
                                    </div></td>
                                </td></tr>
                            </table>
                            ...
                            <li>
                                <table class="sanpham1">
                                        ...
                                        <tr><td>
                                            ...
                                            <div class='imgbox'>
                                                <img href='#' src="./list/tea1.png"  width="180px" height="180px"/>
                                            </div>
            ...
            <li>
                <table class="sanpham1">
                        ...
                        <tr><td>
                            ...
                            <div class='imgbox'>
                                <img href='#' src="./list/tea2.png" width="180px" height="180px"/>
                            </div>
...
<div class="khac">
	...
	<table class="khac1">
			...
			<div class='product'>
				<div class='imgbox'>
					<img href='#' src="./list/cafe.png" width="280px" height="270px"/>
				</div>
		...
		<tr><td>
			<div class='details'>
				<h2>Cà Phê</h2><br>
				<a >Sự kết hợp hoàn hảo giữa hạt cafe Robusta & Arabica <br> thượng hạng được trồng trên những vùng cao nguyên <br> Việt Nam màu 
					mỡ, qua những bí quyết rang...
				</a>
				</div></td>
			</td></tr>
		</table>
