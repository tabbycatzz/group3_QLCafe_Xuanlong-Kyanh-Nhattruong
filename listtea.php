...
<div class="king">
	...
	<div class='long'>
	<h1>TRÀ</h1>
	<img href='#' src="./list/tea1.jpg"/>
	<p>Hương vị tự nhiên, thơm ngon của Trà Việt với phong cách hiện đại tại Coffee Time sẽ
		 giúp bạn gợi mở vị giác của bản thân <br> và tận hưởng một cảm giác thật khoan khoái, tươi mới.</p>
			<!-- <div class="continued"> <input type="submit" value="Xem sản phẩm"/> </div> -->
		</div>
<div class='minhhoa'>
	<img href='#' src="./list/teamain.png"/>
</div>
            ...
            <li>
                <table class="sanpham1">
                        ...
                        <tr><td>
                            ...
                            <div class='imgbox'>
                                <a href="chitiet-tea.php"><img src="./list/tea2.png" width="180px" height="180px"/></a>
                            </div>
